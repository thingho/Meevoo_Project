								...
								<form action="/club/cUpdate2" method="post" name="cUpdateFrom" id="cUpdateFrom" enctype="multipart/form-data" >
								    ...
								    <table>
									  ...
									  <tbody>
									    <tr>
										  ...
										  <td colspan="2">
										    <ul>
										      <li><input type="text" name="sfno" class="sfno" type="button" id="inputField" style="display:block; margin-bottom:0.5em;" value="${cdto.sfno }" onclick="javascript:location.href='/club/cWriteSearchSF_update'" ></input></li>
									    ...
									    <tr>
										  ...
										  <td colspan="2">
										    <ul>
										      <li><input type="text" name="scate" class="scate" value="${cdto.scate }" readonly></li>
										    </ul>
										  </td>
									    </tr>
									    <tr>
										  ...
										  <td colspan="2">
										    <ul>
										      <li><input type="text" name="cnm" class="cnm" value="${cdto.cnm }" ></li>
										    </ul>
										  </td>
									    </tr>
									    <tr>
									    ...
									    <tr>
										  ...
										  <td colspan="2">
										    <ul>
										      <li><input type="number" min="2" max="15" class="crecruitlimit" id="crecruitlimit" name="crecruitlimit" value="${cdto.crecruitlimit }" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" /></li>
										    </ul>
										  </td>
									    </tr>
									    <tr>
										  <th>소개내용 <span style="color: #f56a6a; font-weight: bold;">*</span></th>
										  <td colspan="2">
										    <ul>
										      <li><textarea name="ccontent" class="ccontent" cols="40" rows="5" >${cdto.ccontent }</textarea></li>
										    </ul>
										  </td>
									    </tr>
									    <tr>
									    ...
									    <tr>
										   ...
										   <td colspan="2">
										     <ul class="actions" style="float: right; margin-top: 3em;">
										       <li><input type="button" value="취소" onclick="javascript:location.href='/club/cView?cno=${cdto.cno}';" /></li>
										       <li><input type="reset" value="초기화" /></li>
										       <!-- 
										       <li><input type="button" value="수정" onclick="cUpdateChkBtn()" class="primary" /></li>
										        -->
										       <li><button type="button"  onclick="cUpdateChkBtn()" class="primary" >수정</button></li>
									         </ul>
										 </td>
									   </tr>
									  </tfoot>
								  <!-- 운동모임 작성 입력 버튼 끝-->
								      ...
								      <ul>
								        ...
								        <li><input type="hidden" name="cnowrecruit" id = "cnowrecruit" value="${cdto.cnowrecruit }" ></li>
