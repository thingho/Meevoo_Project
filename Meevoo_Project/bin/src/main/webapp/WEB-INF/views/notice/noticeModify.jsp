...
<html>
   <head>
      ...
      <script>
	     function writeModifyBtn(){
	    	 alert("공지사항이 수정되었습니다.");
	    	 noticeModifyFrm.submit(); //전송
									          ...
									          <div class="row">
									            <div class="col-md-12 col-sm-12">
									              <div class="x_panel">
									                ...
									                <div class="x_content">
									                  <form class="" action="/notice/noticeModify" method="post" name="noticeModifyFrm" enctype="multipart/form-data"
									                    novalidate="">
									                    ...
									                    <div class="field item form-group">
									                      <label class="col-form-label col-md-3 col-sm-3  label-align">제목<span
									                          class="required">*</span></label>
									                      <div class="col-md-6 col-sm-6">
									                        <input class="form-control" type="text" name="notititle" value="${ndto.notititle }" >
									                      </div>
									                    </div>
									                    ...
									                    <div class="field item form-group">
									                      <label class="col-form-label col-md-3 col-sm-3  label-align">작성일<span
									                          class="required">*</span></label>
									                      <div class="col-md-6 col-sm-6">
									                        <input class="form-control" name="notidate" value="${ndto.notidate }"  type="date"  >  <!-- required="required" -->
									                      </div>
									                    </div>
									                    ...
									                    <div class="field item form-group">
									                      <label class="col-form-label col-md-3 col-sm-3  label-align">내용<span
									                          class="required">*</span></label>
									                      <div class="col-md-6 col-sm-6">
									                        <textarea  name="noticontent" >${ndto.noticontent }</textarea>
									                      </div>
									                    </div>
